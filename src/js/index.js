...
$("header .box").mouseenter(function(){ $(this).children('.link').css({'color':'red','background':'#fff'}).next().css("display","block");$(this).children('.link').children('i').removeClass('fa-chevron-down').addClass('fa-chevron-up')});
